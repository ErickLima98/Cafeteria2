...
-- Dumping data for table cafeteria2.cliente: ~0 rows (approximately)
...
-- Dumping data for table cafeteria2.inventario: ~1 rows (approximately)
...
INSERT IGNORE INTO `usuario` (`idUsuario`, `Nombre`, `Contrasenia`, `Acceso_idAcceso`) VALUES
	(3, 'admin', _binary 0x3031393230323361376262643733323530353136663036396466313862353030, 1);
